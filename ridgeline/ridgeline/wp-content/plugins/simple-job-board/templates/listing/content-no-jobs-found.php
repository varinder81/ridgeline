...
echo '<div class="no-job-listing"><p>' . esc_html__( 'No jobs found.', 'simple-job-board' ).'</p><p><a href="' . esc_url(home_url('/')) . $slug . '" class="btn btn-primary"> Back to Jobs Page </a></p></div>';

...
class Simple_Job_Board_Meta_Boxes_Init {
    ...
    public function __construct() {
         ...
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/meta-boxes/class-simple-job-board-meta-box-job-data.php';
          
        /**
         * The class responsible for defining job features meta box options under custom post type in the admin area.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/meta-boxes/class-simple-job-board-meta-box-job-features.php';

        /**
         * The class responsible for defining job application meta box options under custom post type in the admin area.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/meta-boxes/class-simple-job-board-meta-box-job-application.php';
